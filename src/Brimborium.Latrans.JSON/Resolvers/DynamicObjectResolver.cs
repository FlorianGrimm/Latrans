...
namespace Brimborium.Latrans.JSON.Resolvers.Internal {
...
#endif
    {
        ...
        const string ModuleName = "Brimborium.Latrans.JSON.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullFalseNameMutateOriginal";
...
#endif
    {
        ...
        static readonly bool excludeNull = false;
        const string ModuleName = "Brimborium.Latrans.JSON.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullFalseNameMutateCamelCase";
...
#endif
    {
        ...
        static readonly bool excludeNull = false;
        const string ModuleName = "Brimborium.Latrans.JSON.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullFalseNameMutateSnakeCase";
...
#endif
    {
        ...
        const string ModuleName = "Brimborium.Latrans.JSON.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateOriginal";
...
#endif
    {
        ...
        static readonly Func<string, string> nameMutator = StringMutator.ToCamelCase;
        static readonly bool excludeNull = true;
        const string ModuleName = "Brimborium.Latrans.JSON.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateCamelCase";
...
#endif
    {
        ...
        static readonly Func<string, string> nameMutator = StringMutator.ToSnakeCase;
        static readonly bool excludeNull = true;
        const string ModuleName = "Brimborium.Latrans.JSON.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateSnakeCase";
    ...
    internal static class DynamicObjectTypeBuilder
    {
        ...
        static TypeInfo BuildType(DynamicAssembly assembly, Type type, Func<string, string> nameMutator, bool excludeNull)
        {
            ...
            var typeBuilder = assembly.DefineType("Brimborium.Latrans.JSON.Formatters." + SubtractFullNameRegex.Replace(type.FullName, "").Replace(".", "_") + "Formatter" + Interlocked.Increment(ref nameSequence), TypeAttributes.Public | TypeAttributes.Sealed, null, new[] { formatterType });
...

            {
                var method = typeBuilder.DefineMethod("Serialize", MethodAttributes.Public | MethodAttributes.Final | MethodAttributes.Virtual,
                    null,
                    new Type[] { typeof(JsonWriter), type, typeof(IJsonFormatterResolver) });
...

            {
                var method = typeBuilder.DefineMethod("Deserialize", MethodAttributes.Public | MethodAttributes.Final | MethodAttributes.Virtual,
                    type,
                    new Type[] { typeof(JsonReader), typeof(IJsonFormatterResolver) });
        ...
        public static object BuildAnonymousFormatter(Type type, Func<string, string> nameMutator, bool excludeNull, bool allowPrivate, bool isException)
        {
            ...
            var serialize = new DynamicMethod("Serialize", null, new Type[] { typeof(byte[][]), typeof(object[]), typeof(JsonWriter), type, typeof(IJsonFormatterResolver) }, type.Module, true);
            {
            ...
            var deserialize = new DynamicMethod("Deserialize", type, new Type[] { typeof(object[]), typeof(JsonReader), typeof(IJsonFormatterResolver) }, type.Module, true);
            {
        ...
        static void BuildSerialize(Type type, MetaType info, ILGenerator il, Action emitStringByteKeys, Func<int, MetaMember, bool> tryEmitLoadCustomFormatter, bool excludeNull, bool hasShouldSerialize, int firstArgIndex)
        {
            ...
            if (type == typeof(Exception))
            {
                ...
                //{
                //    JsonSerializer.NonGeneric.Serialize(exceptionType, writer, value, formatterResolver);
                //    return;
                //}
            ...
            foreach (var item in info.Members.Where(x => x.IsReadable))
            {
                ...
                if (rawField.Length < 32)
                {
                    ...
                    {
                        il.EmitCall(typeof(UnsafeMemory32).GetRuntimeMethod("WriteRaw" + rawField.Length, new[] { typeof(JsonWriter), typeof(byte[]) }));
                    }
                    else
                    {
                        il.EmitCall(typeof(UnsafeMemory64).GetRuntimeMethod("WriteRaw" + rawField.Length, new[] { typeof(JsonWriter), typeof(byte[]) }));
                    }
                }
                else
                {
...
#if NETSTANDARD
            public static readonly MethodInfo UnsafeMemory_MemoryCopy = ExpressionUtility.GetMethodInfo((Brimborium.Latrans.JSON.JsonWriter writer, byte[] src) 
                => UnsafeMemory.MemoryCopy(writer, src));
#endif
...
#warning JsonSerializerUtf8
            public static readonly MethodInfo NongenericSerialize = ExpressionUtility.GetMethodInfo<Brimborium.Latrans.JSON.JsonWriter>(writer => JsonSerializerUtf8.NonGeneric.Serialize(default(Type), writer, default(object), default(IJsonFormatterResolver)));

            public static MethodInfo Serialize(Type type)
            {
                return typeof(IJsonFormatter<>).MakeGenericType(type).GetRuntimeMethod("Serialize", new[] { typeof(Brimborium.Latrans.JSON.JsonWriter), type, typeof(IJsonFormatterResolver) });
            }

            public static MethodInfo Deserialize(Type type)
            {
                return typeof(IJsonFormatter<>).MakeGenericType(type).GetRuntimeMethod("Deserialize", new[] { typeof(Brimborium.Latrans.JSON.JsonReader), typeof(IJsonFormatterResolver) });
            }
            ...
            {
                public static readonly MethodInfo GetEncodedPropertyNameWithBeginObject = ExpressionUtility.GetMethodInfo(() => Brimborium.Latrans.JSON.JsonWriter.GetEncodedPropertyNameWithBeginObject(default(string)));

                public static readonly MethodInfo GetEncodedPropertyNameWithPrefixValueSeparator = ExpressionUtility.GetMethodInfo(() => Brimborium.Latrans.JSON.JsonWriter.GetEncodedPropertyNameWithPrefixValueSeparator(default(string)));

                public static readonly MethodInfo GetEncodedPropertyNameWithoutQuotation = ExpressionUtility.GetMethodInfo(() => Brimborium.Latrans.JSON.JsonWriter.GetEncodedPropertyNameWithoutQuotation(default(string)));

                public static readonly MethodInfo GetEncodedPropertyName = ExpressionUtility.GetMethodInfo(() => Brimborium.Latrans.JSON.JsonWriter.GetEncodedPropertyName(default(string)));

                public static readonly MethodInfo WriteNull = ExpressionUtility.GetMethodInfo((Brimborium.Latrans.JSON.JsonWriter writer) => writer.WriteNull());
                public static readonly MethodInfo WriteRaw = ExpressionUtility.GetMethodInfo((Brimborium.Latrans.JSON.JsonWriter writer) => writer.WriteRaw(default(byte[])));
                public static readonly MethodInfo WriteBeginObject = ExpressionUtility.GetMethodInfo((Brimborium.Latrans.JSON.JsonWriter writer) => writer.WriteBeginObject());
                public static readonly MethodInfo WriteEndObject = ExpressionUtility.GetMethodInfo((Brimborium.Latrans.JSON.JsonWriter writer) => writer.WriteEndObject());
                public static readonly MethodInfo WriteValueSeparator = ExpressionUtility.GetMethodInfo((Brimborium.Latrans.JSON.JsonWriter writer) => writer.WriteValueSeparator());
            ...
            {
                public static readonly MethodInfo ReadIsNull = ExpressionUtility.GetMethodInfo((Brimborium.Latrans.JSON.JsonReader reader) => reader.ReadIsNull());
                public static readonly MethodInfo ReadIsBeginObjectWithVerify = ExpressionUtility.GetMethodInfo((Brimborium.Latrans.JSON.JsonReader reader) => reader.ReadIsBeginObjectWithVerify());
                public static readonly MethodInfo ReadIsEndObjectWithSkipValueSeparator = ExpressionUtility.GetMethodInfo((Brimborium.Latrans.JSON.JsonReader reader, int count) => reader.ReadIsEndObjectWithSkipValueSeparator(ref count));
                public static readonly MethodInfo ReadPropertyNameSegmentUnsafe = ExpressionUtility.GetMethodInfo((Brimborium.Latrans.JSON.JsonReader reader) => reader.ReadPropertyNameSegmentRaw());
                public static readonly MethodInfo ReadNextBlock = ExpressionUtility.GetMethodInfo((Brimborium.Latrans.JSON.JsonReader reader) => reader.ReadNextBlock());
                public static readonly MethodInfo GetBufferUnsafe = ExpressionUtility.GetMethodInfo((Brimborium.Latrans.JSON.JsonReader reader) => reader.GetBufferUnsafe());
                public static readonly MethodInfo GetCurrentOffsetUnsafe = ExpressionUtility.GetMethodInfo((Brimborium.Latrans.JSON.JsonReader reader) => reader.GetCurrentOffsetUnsafe());
            ...
            {
                internal static readonly MethodInfo FormatterType = ExpressionUtility.GetPropertyInfo((Brimborium.Latrans.JSON.JsonFormatterAttribute attr) => attr.FormatterType).GetGetMethod();
                internal static readonly MethodInfo Arguments = ExpressionUtility.GetPropertyInfo((Brimborium.Latrans.JSON.JsonFormatterAttribute attr) => attr.Arguments).GetGetMethod();
            }
        }
    ...
    internal delegate void AnonymousJsonSerializeAction<T>(byte[][] stringByteKeysField, object[] customFormatters, JsonWriter writer, T value, IJsonFormatterResolver resolver);
    internal delegate T AnonymousJsonDeserializeFunc<T>(object[] customFormatters, JsonReader reader, IJsonFormatterResolver resolver);
    ...
    internal class DynamicMethodAnonymousFormatter<T> : IJsonFormatter<T>
    {
        ...
        public T Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            ...
            return deserialize(deserializeCustomFormatters, reader, formatterResolver);
        }
    }
}