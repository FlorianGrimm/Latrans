            ...
            else
            {
                ...
                for (int i = 0; i < iLength; i++)
                {
                    ...
                    for (int j = 0; j < jLength; j++)
                    {
                        ...
                        formatter.Serialize(writer, value[i, j], formatterResolver);
                    }
                ...
                for (int i = 0; i < iLength; i++)
                {
                    ...
                    for (int j = 0; j < jLength; j++)
                    {
                        ...
                        for (int k = 0; k < kLength; k++)
                        {
                            ...
                            formatter.Serialize(writer, value[i, j, k], formatterResolver);
                        }
                        writer.WriteEndArray();
                    }
                    writer.WriteEndArray();
        ...
        public T[,,] Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            ...
            while (!reader.ReadIsEndArrayWithSkipValueSeparator(ref outerCount))
            {
                ...
                while (!reader.ReadIsEndArrayWithSkipValueSeparator(ref innerCount))
                {
                    ...
                    {
                        innerArray2.Add(formatter.Deserialize(reader, formatterResolver));
                    }
                    ...
                    for (int j = 0; j < jLength; j++)
                    {
                        ...
                        for (int k = 0; k < kLength; k++)
                        {
                            ...
                            for (int l = 0; l < lLength; l++)
                            {
                                ...
                                formatter.Serialize(writer, value[i, j, k, l], formatterResolver);
                            }
                            writer.WriteEndArray();
                        }
                        writer.WriteEndArray();
            ...
            while (!reader.ReadIsEndArrayWithSkipValueSeparator(ref outerCount))
            {
                ...
                while (!reader.ReadIsEndArrayWithSkipValueSeparator(ref innerCount))
                {
                    ...
                    while (!reader.ReadIsEndArrayWithSkipValueSeparator(ref innerCount2))
                    {
                        ...
                        {
                            innerArray3.Add(formatter.Deserialize(reader, formatterResolver));
                        }
