...
namespace Brimborium.Latrans.JSON.Formatters {
    public sealed class DTFormatter
        ...
        public DateTime Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver) {
            if (reader is JsonReaderUtf8 jsonReaderUtf8) {
                return ((IJsonFormatterSpecReader<DateTime, JsonReaderUtf8>)this).DeserializeSpec(jsonReaderUtf8, formatterResolver);
            }
            throw new NotImplementedException();
        }

        public void Serialize(JsonWriter writer, DateTime value, IJsonFormatterResolver formatterResolver) {
            if (writer is JsonWriterUtf8 jsonWriterUtf8) {
                ((IJsonFormatterSpecWriter<DateTime, JsonWriterUtf8>)this).SerializeSpec(jsonWriterUtf8, value, formatterResolver);
            }
            throw new NotImplementedException();
        }

        void IJsonFormatterSpecWriter<DateTime, JsonWriterUtf8>.SerializeSpec(JsonWriterUtf8 writer, DateTime value, IJsonFormatterResolver formatterResolver) {
            throw new NotImplementedException();
        }
    ...
    public sealed class DTFormatterUtf8
        : IJsonFormatterSpecReader<DateTime, JsonReaderUtf8>
        , IJsonFormatterSpecWriter<DateTime, JsonWriterUtf8> {
        public DateTime DeserializeSpec(JsonReaderUtf8 reader, IJsonFormatterResolver formatterResolver) {
            throw new NotImplementedException();
        }
    ...
    public sealed class NullableDateTimeFormatter : IJsonFormatter<DateTime?> {
        ...
        public void Serialize(JsonWriter writer, DateTime? value, IJsonFormatterResolver formatterResolver) {
            ...
            innerFormatter.Serialize(writer, value.Value, formatterResolver);
        }

        public DateTime? Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver) {
            if (reader.ReadIsNull()) return null;

            return innerFormatter.Deserialize(reader, formatterResolver);
        }
    }
    ...
    public sealed class DateTimeOffsetFormatter : IJsonFormatter<DateTimeOffset> {
        ...
        public void Serialize(JsonWriter writer, DateTimeOffset value, IJsonFormatterResolver formatterResolver) {
            writer.WriteString(value.ToString(formatString));
        }

        public DateTimeOffset Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver) {
            var str = reader.ReadString();
            if (formatString == null) {
