...
using System.Text;
using Brimborium.Latrans.JSON.Formatters.Internal;
...
namespace Brimborium.Latrans.JSON.Formatters
{
    ...
    public sealed class ByteArrayFormatter : IJsonFormatter<byte[]>
    {
        ...
        public void Serialize(JsonWriter writer, byte[] value, IJsonFormatterResolver formatterResolver)
        {
        ...
        public byte[] Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
    ...
    public sealed class ByteArraySegmentFormatter : IJsonFormatter<ArraySegment<byte>>
    {
        ...
        public void Serialize(JsonWriter writer, ArraySegment<byte> value, IJsonFormatterResolver formatterResolver)
        {
        ...
        public ArraySegment<byte> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
    ...
    public sealed class NullableStringFormatter : IJsonFormatter<string>, IObjectPropertyNameFormatter<string>
    {
        ...
        public void Serialize(JsonWriter writer, string value, IJsonFormatterResolver formatterResolver)
        {
            writer.WriteString(value);
        }

        public string Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            return reader.ReadString();
        }

        public void SerializeToPropertyName(JsonWriter writer, string value, IJsonFormatterResolver formatterResolver)
        {
            writer.WriteString(value);
        }

        public string DeserializeFromPropertyName(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            return reader.ReadString();
        }
    }
    ...
    public sealed class CharFormatter : IJsonFormatter<char>
    {
        ...
        public void Serialize(JsonWriter writer, char value, IJsonFormatterResolver formatterResolver)
        {
            writer.WriteString(value.ToString(CultureInfo.InvariantCulture));
        }

        public char Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
    ...
    public sealed class NullableCharFormatter : IJsonFormatter<Char?>
    {
        ...
        public void Serialize(JsonWriter writer, Char? value, IJsonFormatterResolver formatterResolver)
        {
            ...
            {
                CharFormatter.Default.Serialize(writer, value.Value, formatterResolver);
            }
        }
        ...
        public Char? Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            ...
            {
                return CharFormatter.Default.Deserialize(reader, formatterResolver);
            }
        }
    }
    ...
    public sealed class CharArrayFormatter : IJsonFormatter<char[]>
    {
        ...
        public void Serialize(JsonWriter writer, char[] value, IJsonFormatterResolver formatterResolver)
        {
            ...
            else
            {
                ...
                if (value.Length != 0)
                {
                    CharFormatter.Default.Serialize(writer, value[0], formatterResolver);
                }
                for (int i = 1; i < value.Length; i++)
                {
                    writer.WriteValueSeparator();
                    CharFormatter.Default.Serialize(writer, value[i], formatterResolver);
                }
        ...
        public char[] Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            ...
            else
            {
                ...
                while (!reader.ReadIsEndArrayWithSkipValueSeparator(ref count))
                {
                    ...
                    array[count - 1] = CharFormatter.Default.Deserialize(reader, formatterResolver);
                }
    ...
    public sealed class GuidFormatter : IJsonFormatter<Guid>, IObjectPropertyNameFormatter<Guid>
    {
        ...
        public void Serialize(JsonWriter writer, Guid value, IJsonFormatterResolver formatterResolver)
        {
        ...
        public Guid Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            var segment = reader.ReadStringSegmentUnsafe();
            return new GuidBits(ref segment).Value;
        }

        public void SerializeToPropertyName(JsonWriter writer, Guid value, IJsonFormatterResolver formatterResolver)
        {
            Serialize(writer, value, formatterResolver);
        }

        public Guid DeserializeFromPropertyName(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
    ...
    public sealed class UriFormatter : IJsonFormatter<Uri>
    {
        ...
        public void Serialize(JsonWriter writer, Uri value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null)
            {
                writer.WriteNull();
        ...
        public Uri Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull())
            {
                return null;
    ...
    public sealed class VersionFormatter : IJsonFormatter<Version>
    {
        ...
        public void Serialize(JsonWriter writer, Version value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null)
            {
                writer.WriteNull();
        ...
        public Version Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull())
            {
                return null;
    ...
    {
        public void Serialize(JsonWriter writer, KeyValuePair<TKey, TValue> value, IJsonFormatterResolver formatterResolver)
        {
        ...
        public KeyValuePair<TKey, TValue> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            ...
            while (!reader.ReadIsEndObjectWithSkipValueSeparator(ref count))
            {
                ...
                {
                    case 0:
                        resultKey = formatterResolver.GetFormatterWithVerify<TKey>().Deserialize(reader, formatterResolver);
                        break;
                    case 1:
                        resultValue = formatterResolver.GetFormatterWithVerify<TValue>().Deserialize(reader, formatterResolver);
                        break;
                    default:
    ...
    public sealed class StringBuilderFormatter : IJsonFormatter<StringBuilder>
    {
        ...
        public void Serialize(JsonWriter writer, StringBuilder value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
            writer.WriteString(value.ToString());
        }

        public StringBuilder Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
    ...
    public sealed class BitArrayFormatter : IJsonFormatter<BitArray>
    {
        ...
        public void Serialize(JsonWriter writer, BitArray value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
        ...
        public BitArray Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
            reader.ReadIsBeginArrayWithVerify();
            var c = 0;
    ...
    public sealed class TypeFormatter : IJsonFormatter<Type>
    {
        ...
        public void Serialize(JsonWriter writer, Type value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
        ...
        public Type Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
    ...
    public sealed class BigIntegerFormatter : IJsonFormatter<BigInteger>
    {
        ...
        public void Serialize(JsonWriter writer, BigInteger value, IJsonFormatterResolver formatterResolver)
        {
            // JSON.NET writes Integer format, not compatible.
            writer.WriteString(value.ToString(CultureInfo.InvariantCulture));
        }

        public BigInteger Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            var s = reader.ReadString();
    ...
    public sealed class ComplexFormatter : IJsonFormatter<Complex>
    {
        ...
        public void Serialize(JsonWriter writer, Complex value, IJsonFormatterResolver formatterResolver)
        {
            writer.WriteBeginArray();
        ...
        public Complex Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            reader.ReadIsBeginArrayWithVerify();
    ...
    public sealed class ExpandoObjectFormatter : IJsonFormatter<ExpandoObject>
    {
        ...
        public void Serialize(JsonWriter writer, ExpandoObject value, IJsonFormatterResolver formatterResolver)
        {
            var formatter = formatterResolver.GetFormatterWithVerify<IDictionary<string, object>>();
            formatter.Serialize(writer, (IDictionary<string, object>)value, formatterResolver);
        }

        public ExpandoObject Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            ...
            while (reader.ReadIsInObject(ref c))
            {
                ...
                var value = objectFormatter.Deserialize(reader, formatterResolver);
    ...
    {
        public void Serialize(JsonWriter writer, Lazy<T> value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
            formatterResolver.GetFormatterWithVerify<T>().Serialize(writer, value.Value, formatterResolver);
        }

        public Lazy<T> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;

            // deserialize immediately(no delay, because capture byte[] causes memory leak)
            var v = formatterResolver.GetFormatterWithVerify<T>().Deserialize(reader, formatterResolver);
#if NETSTANDARD
    ...
    public sealed class TaskUnitFormatter : IJsonFormatter<Task>
    {
        ...
        public void Serialize(JsonWriter writer, Task value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
        ...
        public Task Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
    ...
    {
        public void Serialize(JsonWriter writer, Task<T> value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
        ...
        public Task<T> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
    ...
    {
        public void Serialize(JsonWriter writer, ValueTask<T> value, IJsonFormatterResolver formatterResolver)
        {
            // value.Result -> wait...!
            formatterResolver.GetFormatterWithVerify<T>().Serialize(writer, value.Result, formatterResolver);
        }

        public ValueTask<T> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            var v = formatterResolver.GetFormatterWithVerify<T>().Deserialize(reader, formatterResolver);
...
namespace Brimborium.Latrans.JSON.Formatters.Internal
{
