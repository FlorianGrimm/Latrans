...
namespace Brimborium.Latrans.JSON.Formatters
{
    ...
    public sealed class TupleFormatter<T1> : IJsonFormatter<Tuple<T1>>
    {
        ...
        public void Serialize(JsonWriter writer, Tuple<T1> value, IJsonFormatterResolver formatterResolver)
        {
        ...
        public Tuple<T1> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
    ...
    public sealed class TupleFormatter<T1, T2> : IJsonFormatter<Tuple<T1, T2>>
    {
        ...
        public void Serialize(JsonWriter writer, Tuple<T1, T2> value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
        ...
        public Tuple<T1, T2> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
    ...
    public sealed class TupleFormatter<T1, T2, T3> : IJsonFormatter<Tuple<T1, T2, T3>>
    {
        ...
        public void Serialize(JsonWriter writer, Tuple<T1, T2, T3> value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
        ...
        public Tuple<T1, T2, T3> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
    ...
    public sealed class TupleFormatter<T1, T2, T3, T4> : IJsonFormatter<Tuple<T1, T2, T3, T4>>
    {
        ...
        public void Serialize(JsonWriter writer, Tuple<T1, T2, T3, T4> value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
        ...
        public Tuple<T1, T2, T3, T4> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
    ...
    public sealed class TupleFormatter<T1, T2, T3, T4, T5> : IJsonFormatter<Tuple<T1, T2, T3, T4, T5>>
    {
        ...
        public void Serialize(JsonWriter writer, Tuple<T1, T2, T3, T4, T5> value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
        ...
        public Tuple<T1, T2, T3, T4, T5> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
    ...
    public sealed class TupleFormatter<T1, T2, T3, T4, T5, T6> : IJsonFormatter<Tuple<T1, T2, T3, T4, T5, T6>>
    {
        ...
        public void Serialize(JsonWriter writer, Tuple<T1, T2, T3, T4, T5, T6> value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
        ...
        public Tuple<T1, T2, T3, T4, T5, T6> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
    ...
    public sealed class TupleFormatter<T1, T2, T3, T4, T5, T6, T7> : IJsonFormatter<Tuple<T1, T2, T3, T4, T5, T6, T7>>
    {
        ...
        public void Serialize(JsonWriter writer, Tuple<T1, T2, T3, T4, T5, T6, T7> value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
        ...
        public Tuple<T1, T2, T3, T4, T5, T6, T7> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
    ...
    public sealed class TupleFormatter<T1, T2, T3, T4, T5, T6, T7, TRest> : IJsonFormatter<Tuple<T1, T2, T3, T4, T5, T6, T7, TRest>>
    {
        ...
        public void Serialize(JsonWriter writer, Tuple<T1, T2, T3, T4, T5, T6, T7, TRest> value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
        ...
        public Tuple<T1, T2, T3, T4, T5, T6, T7, TRest> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
