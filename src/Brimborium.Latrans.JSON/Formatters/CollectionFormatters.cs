...
namespace Brimborium.Latrans.JSON.Formatters
{
        ...
        public T[] Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            ...
            try
            {
                ...
                while (!reader.ReadIsEndArrayWithSkipValueSeparator(ref count))
                {
                    ...
                    array[count - 1] = formatter.Deserialize(reader, formatterResolver);
                }
    ...
    public class ArraySegmentFormatter<T> : IJsonFormatter<ArraySegment<T>>
    {
        ...
        public ArraySegment<T> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
    ...
    {
        public void Serialize(JsonWriter writer, List<T> value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null) { writer.WriteNull(); return; }
        ...
        public List<T> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
            ...
            while (!reader.ReadIsEndArrayWithSkipValueSeparator(ref count))
            {
                list.Add(formatter.Deserialize(reader, formatterResolver));
            }
    ...
    {
        public void Serialize(JsonWriter writer, TCollection value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null)
            {
                writer.WriteNull();
        ...
        public TCollection Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            ...
            else
            {
                ...
                while (!reader.ReadIsEndArrayWithSkipValueSeparator(ref count))
                {
                    Add(ref builder, count - 1, formatter.Deserialize(reader, formatterResolver));
                }
    ...
    {
        public void Serialize(JsonWriter writer, IGrouping<TKey, TElement> value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null)
            {
                writer.WriteNull();
            ...
            else
            {
                ...
                formatterResolver.GetFormatterWithVerify<IEnumerable<TElement>>().Serialize(writer, value.AsEnumerable(), formatterResolver);

                writer.WriteEndObject();
            }
        }

        public IGrouping<TKey, TElement> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull())
            {
                return null;
                ...
                while (!reader.ReadIsEndObjectWithSkipValueSeparator(ref count))
                {
                    ...
                    switch (key)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            resultValue = formatterResolver.GetFormatterWithVerify<IEnumerable<TElement>>().Deserialize(reader, formatterResolver);
                            break;
                        default:
    ...
    {
        public void Serialize(JsonWriter writer, ILookup<TKey, TElement> value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null)
            {
                writer.WriteNull();
            ...
            {
                formatterResolver.GetFormatterWithVerify<IEnumerable<IGrouping<TKey, TElement>>>().Serialize(writer, value.AsEnumerable(), formatterResolver);
            }
        }

        public ILookup<TKey, TElement> Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull())
            {
                return null;
            ...
            else
            {
                ...
                while (!reader.ReadIsEndArrayWithSkipValueSeparator(ref count))
                {
                    var g = formatter.Deserialize(reader, formatterResolver);
    ...
    public sealed class NonGenericInterfaceEnumerableFormatter : IJsonFormatter<IEnumerable>
    {
        ...
        public void Serialize(JsonWriter writer, IEnumerable value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null)
            {
                writer.WriteNull();
        ...
        public IEnumerable Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
    ...
    public sealed class NonGenericInterfaceCollectionFormatter : IJsonFormatter<ICollection>
    {
        ...
        public void Serialize(JsonWriter writer, ICollection value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null)
            {
                writer.WriteNull();
        ...
        public ICollection Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
    ...
    public sealed class NonGenericInterfaceListFormatter : IJsonFormatter<IList>
    {
        ...
        public IList Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
            if (reader.ReadIsNull()) return null;
