...
namespace Brimborium.Latrans.JSON.Formatters
{
    public sealed class PrimitiveObjectFormatter : IJsonFormatter<object>
    {
        ...
        public void Serialize(JsonWriter writer, object value, IJsonFormatterResolver formatterResolver)
        {
            if (value == null)
            {
                writer.WriteNull();
            ...
            if (typeToJumpCode.TryGetValue(t, out key))
            {
                switch (key)
                {
                    ...
                    case 1: CharFormatter.Default.Serialize(writer, (char)value, formatterResolver); return;
                    ...
                    case 12: ISO8601DateTimeFormatter.Default.Serialize(writer, (DateTime)value, formatterResolver); return;
                    case 13: writer.WriteString((string)value); return;
                    case 14: ByteArrayFormatter.Default.Serialize(writer, (byte[])value, formatterResolver); return;
                    default:
                        break;
                }
            }
        ...
        public object Deserialize(JsonReader reader, IJsonFormatterResolver formatterResolver)
        {
                ...
                case JsonToken.BeginObject:
                    {
                        ...
                        while (!reader.ReadIsEndObjectWithSkipValueSeparator(ref count))
                        {
                            ...
                            var value = Deserialize(reader, formatterResolver);
                            dict.Add(key, value);
                        }
                        return dict;
                    }
                case JsonToken.BeginArray:
                    {
                        ...
                        {
                            list.Add(Deserialize(reader, formatterResolver));
                        }
                        return list;
                    }
