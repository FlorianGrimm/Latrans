        ...
        public override int Read(byte[] buffer, int offset, int count) {
            lock (this) {
                ...
                do {
                    ...
                    read += (int)copysize;
                    position += copysize;
                    //System.Threading.Interlocked.Add(ref position, copysize);
                } while (lcount > 0);
                System.Threading.Interlocked.Exchange(ref position, position);
        ...
        public override void Write(byte[] buffer, int offset, int count) {
            lock (this) {
                ...
                try {
                    ...
                    System.Threading.Interlocked.Exchange(ref this._Position, initialPosition);
                    throw;
                }
            }
        }
...
#if false
        public byte[] ToArray() {
            long firstposition = this.Position;
            this.Position = 0;
