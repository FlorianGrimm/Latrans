...
#line 1 "C:\Users\y.kawai\Documents\neuecc\Utf8Json\src\Utf8Json.CodeGenerator\Generator\ResolverTemplate.tt"
    ...
    public partial class ResolverTemplate : ResolverTemplateBase {
        ...
        static class FormatterCache<T>
        {
            ...
            this.Write("                if (f != null)\r\n");
            this.Write("                {\r\n");
            this.Write("                    formatter = (global::Brimborium.Latrans.JSON.IJsonFormatter<T>)f;\r\n");
            this.Write("                }\r\n");
            this.Write("            }\r\n");
            this.Write("        }\r\n");
            this.Write("    }\r\n");
            this.Write("\r\n");
            this.Write("    internal static class ");
            this.Write(this.ToStringHelper.ToStringWithCulture(ResolverName));
            this.Write("GetFormatterHelper\r\n");
            this.Write("    {\r\n");
            this.Write("        static readonly global::System.Collections.Generic.Dictionary<Type, int> lookup;\r\n");
            this.Write("\r\n");
            this.Write("        static ");
            this.Write(this.ToStringHelper.ToStringWithCulture(ResolverName));
            this.Write("GetFormatterHelper()\r\n");
            this.Write("        {\r\n");
            this.Write("            lookup = new global::System.Collections.Generic.Dictionary<Type, int>(");
            ...
            this.Write("        }\r\n");
            this.Write("\r\n");
            this.Write("        internal static object GetFormatter(Type t)\r\n");
            this.Write("        {\r\n");
            this.Write("            int key;\r\n");
            this.Write("            if (!lookup.TryGetValue(t, out key" +
                    ")) return null;\r\n");
            this.Write("\r\n");
